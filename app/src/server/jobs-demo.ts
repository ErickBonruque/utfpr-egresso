...
const DEMO_JOBS: DemoJob[] = [
  ...
  },
  {
    ...
    description:
      "Construção de relatórios e painéis para as áreas de negócio, modelagem em SQL e apoio à governança de dados. Aberta a recém-formados em Computação, Estatística ou Engenharia.",
    daysAgo: 2,
    isRemote: false,
    contractType: "full_time",
    salary: { min: 4000, max: 6000 },
    keywords: ["dados", "análise de dados", "sql", "business intelligence"],
  },
  {
    id: "demo-cc-8",
    title: "Engenheiro(a) de Dados (Remoto)",
    company: "Vertigo Tecnologia",
    location: "Curitiba, Paraná",
    description:
      "Construção e manutenção de pipelines de dados em nuvem, orquestração de cargas e modelagem de data warehouse. Trabalho remoto com encontros presenciais trimestrais.",
    daysAgo: 6,
    isRemote: true,
    contractType: "permanent",
    salary: { min: 8000, max: 12000 },
    keywords: ["dados", "engenharia de dados", "pipeline", "nuvem", "sql"],
  },
  {
    id: "demo-cc-3",
